...
export default function ModalAguardar(props) {

    const { modalAguardar, setModalAguardar } = props.states
        ...
        <View style={estilos.modalContainer}>
            <View style={estilos.modalContent}>
                <View style={estilos.confirmacao} >
                    ...
                    <Text style={estilos.mensagemConfirmacao}>Aguarde a confirmação do estacionamento para a sua saída...</Text>
                </View>
            </View>
        </View>
    )
